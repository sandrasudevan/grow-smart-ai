...
CREATE POLICY "System can manage reputation" ON public.user_reputation FOR INSERT USING (true);

CREATE POLICY "Users can view all badges" ON public.user_badges FOR SELECT USING (true);
CREATE POLICY "System can award badges" ON public.user_badges FOR INSERT USING (true);
